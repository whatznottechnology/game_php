...
<div class="w-64 bg-gray-900 min-h-screen text-white">
    <div class="p-6">
        <nav class="space-y-2">
            ...
            <!-- Platforms -->
            <a href="platforms.php" class="flex items-center px-4 py-3 rounded-lg <?php echo basename($_SERVER['PHP_SELF']) === 'platforms.php' ? 'bg-blue-600' : 'hover:bg-gray-800'; ?> transition-colors">
                <i class="fas fa-server w-6"></i>
                <span class="ml-3 font-semibold">Platforms</span>
            </a>
